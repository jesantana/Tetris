...
namespace t1
{
	...
	public class LIzquierda:Figura
	{
		public LIzquierda()
		{
			...
			public override void TomaEstado()
			{
				switch(tipo)
				{
					case 1:this.estado=new int[,]{{1,-1},{0,-1},{0,0},{0,1}};this.alto=1;this.ld=this.liz=1;break;
					case 2:this.estado=new int[,]{{-1,0},{0,0},{1,0},{1,1}};this.alto=1;this.ld=1;this.liz=0;break;	
					case 3:this.estado=new int[,]{{0,-1},{0,0},{0,1},{-1,1}};this.alto=0;this.ld=this.liz=1;break;			
					case 0:this.estado=new int[,]{{-1,-1},{-1,0},{0,0},{1,0}};this.alto=1;this.ld=0;this.liz=1;break;			
		...
		public override int[,] ProximoEstado()
		{
			switch(tipo)
			{
				...
				case 2:return new int[,]{{0,-1},{0,0},{0,1},{-1,1}};
